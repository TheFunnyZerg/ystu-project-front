...
interface SemesterTableProps {
    columns: number;
    rows: TableRow[];
    handleDragStart: (discipline: Discipline, rowIndex?: number, colIndex?: number) => void;
    handleDrop: (e: React.DragEvent<HTMLTableCellElement>, rowIndex: number, colIndex: number) => void;
